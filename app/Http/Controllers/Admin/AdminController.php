...
class AdminController extends Controller
{
    ...
    //pation & doctor & list
    public function pation_doctor_list(){

// Retrieve a patient and their related appointment and doctor
$patient = Patient::find(1);
$appointment = $patient->appointment; // Get the related appointment
$doctor = $patient->doctor; // Get the related doctor

// Retrieve a doctor and their related patients and appointments
$doctor = Doctor::find(1);
$patients = $doctor->patients; // Get all patients related to the doctor
$appointments = $doctor->appointments; // Get all appointments related to the doctor


        // return view('admin.patient');
        return view('admin.patient', compact('patient', 'appointment', 'doctor', 'patients', 'appointments'));
    }
